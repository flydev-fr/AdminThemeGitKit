...
$config->scripts->append($config->urls->adminTemplates . "uikit/custom/scripts/headroom.$ext");
$config->scripts->append($config->urls->adminTemplates . "uikit/custom/scripts/jQuery.headroom.$ext");
